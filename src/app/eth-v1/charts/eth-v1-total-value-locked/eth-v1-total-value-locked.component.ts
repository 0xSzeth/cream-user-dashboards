...
@Component({
  selector: 'app-eth-v1-total-value-locked',
  templateUrl: './eth-v1-total-value-locked.component.html',
  styleUrls: ['./eth-v1-total-value-locked.component.css']
})
  ...
  async handleData(data: QueryResult) {
    ...
    for (let market in markets) {
      ...
      dataobj = {
        ...
        label: markets[market].underlyingSymbol === 'SLP' || 'UNI-V2' ? markets[market].symbol.substring(2) : markets[market].underlyingSymbol,

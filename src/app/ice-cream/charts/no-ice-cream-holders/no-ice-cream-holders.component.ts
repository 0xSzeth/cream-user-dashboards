...
@Component({
  selector: 'app-no-ice-cream-holders',
  templateUrl: './no-ice-cream-holders.component.html',
  styleUrls: ['./no-ice-cream-holders.component.css']
})
export class NoIceCreamHoldersComponent implements OnInit {
  // constants
  COLORS: string[] = [
    '44, 123, 229',
    '255, 103, 155',
